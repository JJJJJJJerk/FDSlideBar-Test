...
- (void)setupSlideBar {
    ...
    sliderBar.itemsTitle = @[@"里程积分", @"鞍时积分", @"综合积分"];
...
- (void)setupTableView {
    ...
    UINib *nib = [UINib nibWithNibName:@"TVCellForSlideContent" bundle:nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    TVCellForSlideContent *cell = [self.tableView dequeueReusableCellWithIdentifier:@"ContentCell"];
